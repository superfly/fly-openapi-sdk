...
# Unit tests for FlyApi::SignalRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FlyApi::SignalRequest do
  let(:instance) { FlyApi::SignalRequest.new }

  describe 'test an instance of SignalRequest' do
    it 'should create an instance of SignalRequest' do
      expect(instance).to be_instance_of(FlyApi::SignalRequest)
    end
  end
