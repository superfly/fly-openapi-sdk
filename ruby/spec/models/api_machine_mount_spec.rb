...
# Unit tests for FlyApi::ApiMachineMount
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FlyApi::ApiMachineMount do
  let(:instance) { FlyApi::ApiMachineMount.new }

  describe 'test an instance of ApiMachineMount' do
    it 'should create an instance of ApiMachineMount' do
      expect(instance).to be_instance_of(FlyApi::ApiMachineMount)
    end
  end
