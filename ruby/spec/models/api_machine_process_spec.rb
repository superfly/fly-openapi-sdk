...
# Unit tests for FlyApi::ApiMachineProcess
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FlyApi::ApiMachineProcess do
  let(:instance) { FlyApi::ApiMachineProcess.new }

  describe 'test an instance of ApiMachineProcess' do
    it 'should create an instance of ApiMachineProcess' do
      expect(instance).to be_instance_of(FlyApi::ApiMachineProcess)
    end
  end
