...
# Unit tests for FlyApi::ApiStopConfig
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FlyApi::ApiStopConfig do
  let(:instance) { FlyApi::ApiStopConfig.new }

  describe 'test an instance of ApiStopConfig' do
    it 'should create an instance of ApiStopConfig' do
      expect(instance).to be_instance_of(FlyApi::ApiStopConfig)
    end
  end
