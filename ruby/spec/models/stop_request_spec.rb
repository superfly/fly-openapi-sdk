...
# Unit tests for FlyApi::StopRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FlyApi::StopRequest do
  let(:instance) { FlyApi::StopRequest.new }

  describe 'test an instance of StopRequest' do
    it 'should create an instance of StopRequest' do
      expect(instance).to be_instance_of(FlyApi::StopRequest)
    end
  end
